import { Scene, PerspectiveCamera, WebGLRenderer, Object3D, Color, AmbientLight, PointLight, GridHelper, Camera, LineBasicMaterial } from "three/src/Three";
...
export class Render {
    ...
    constructor(configs: Configs) {
        ...
        else for (let material of <LineBasicMaterial[]>grid.material)
    ...
    bindTileMapEvent(tilemap: TileMap) {
        ...
        document.addEventListener('mousemove', this.tilemap.onDocumentMouseMove.bind(this.tilemap), false);
        document.addEventListener('mousedown', this.tilemap.onDocumentMouseDown.bind(this.tilemap), false);
    }
