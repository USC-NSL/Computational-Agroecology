...
export function pos2grid(pos: number) { return (pos + 45) / 10; };
export function grid2pos(grid: number) { return -45 + 10 * grid; };
...
export interface tilemap_color {
    [name: string]: number;
}
...
export const plant_configs: plants = {
    "CORN": [
        {   // status 0
            ...
            model: "corn_stage_1",
            scaleX: 0.75, scaleY: 0.75, scaleZ: 0.75,
        }, {   // status 2
            model: "corn_stage_1",
            ...
            model: "corn_stage_2",
            scaleX: 1.25, scaleY: 1.25, scaleZ: 1.25,
        }, {   // status 5
            model: "corn_stage_2",
            ...
            model: "corn_stage_3",
            scaleX: 1.75, scaleY: 1.75, scaleZ: 1.75,
        }, {   // status 8
            model: "corn_stage_3",
