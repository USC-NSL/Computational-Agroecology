...
var call = createAgentService.createAgent(request, {}, function (err: { code: any; message: any; }, response: { getMessage: () => void; }) {
  if (err) {
...
call.on('status', function (status: { code: any; details: any; metadata: any; }) {
