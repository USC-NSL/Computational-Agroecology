#ifndef COMPUTATIONAL_AGROECOLOGY_SIMULATORS_SIMULATOR_H_
#define COMPUTATIONAL_AGROECOLOGY_SIMULATORS_SIMULATOR_H_
...
#endif  // COMPUTATIONAL_AGROECOLOGY_SIMULATORS_SIMULATOR_H_