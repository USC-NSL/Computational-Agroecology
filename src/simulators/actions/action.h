#ifndef COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_ACTION_H_
#define COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_ACTION_H_
...
#endif  // COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_ACTION_H_