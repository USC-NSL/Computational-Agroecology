#ifndef COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_CROP_H_
#define COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_CROP_H_
...
#endif  // COMPUTATIONAL_AGROECOLOGY_SIMULATORS_ACTIONS_CROP_H_