...
PHOTON_SIMULATOR_PHOTON_OBJ := $(PHOTON_SIMULATOR_PHOTON_PATH)/neighbor.o \
	$(PHOTON_SIMULATOR_PHOTON_PATH)/photon.o
...
TEST_ENVIRONMENT := $(TEST_ENVIRONMENT_PATH)/climate_test \
	...
	$(TEST_ENVIRONMENT_PATH)/meteo_info_test \
