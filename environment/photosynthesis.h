...
class Photosynthesis {
 ...
 private:
  ...
  //   deg. C)
  double Q10TemperatureSensitivity(double michaelis_menten_constant_25_degrees,
                                   double q10_temperature_sensitivity,
                                   double leaf_temperature);
  ...
  double PhotosynthesisLimitedByLight(double par, double leaf_temperature,
                                      double co2_concentration);

  // Gross photosynthesis limited by Rubisco capacity (umol m-2 s-1)
  //   lftemp (leaf temperature, deg. C),
  //   ci (intercellular CO2 concentration, umol mol-1)
  double PhotosynthesisLimitedByRubisco(double leaf_temperature,
                                        double co2_concentration);
  ...
  static constexpr double michaelis_menten_co2_25_degrees =
      300.0;  // michaelis menten constant for co2 at 25 degrees celsius
  static constexpr double michaelis_menten_o2_25_degrees =
