...
const environment::Soil beanSoil(environment::Soil::CLAY, 6.0, 1.0, 2.0, 3.0, environment::Soil::HIGH, environment::Soil::HIGH);
...
Bean::Bean()
    : PlantType(kBeanTypeName, "o", true, 0.0, MaxMinTemperature(0, 0),
                ...
                beanSoil, beanSoil, beanLight, beanLight, MaxMinPair<int>(100, 10)) {}
