...
const environment::Soil squashSoil(environment::Soil::CLAY, 6.0, 1.0, 2.0, 3.0,
...
Squash::Squash()
    : PlantType(kSquashTypeName, "-", true, 0.0, MaxMinTemperature(0, 0),
                ...
                MaxMinPair<int>(100, 10), squashSoil, squashSoil, squashLight,
                squashLight, MaxMinPair<int>(100, 10)) {}
