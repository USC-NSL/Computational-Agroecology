...
const environment::Soil cornSoil(environment::Soil::CLAY, 6.0, 1.0, 2.0, 3.0, environment::Soil::HIGH, environment::Soil::HIGH);
...
Corn::Corn()
    : PlantType(kCornTypeName, "🌽", true, 0.0, MaxMinTemperature(0, 0),
                ...
                cornSoil, cornSoil, cornLight, cornLight, MaxMinPair<int>(100, 10)) {}
