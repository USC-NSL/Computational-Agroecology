...
namespace simulator {
  ...
  private:
    ...
    void FirstStep(int _year, int _month, int _day, int _hour, double _longitude, double _latitude);
    void SecondStep();
    void ThirdStep();
    void FourthStep();
    void FifthStep();
    ...
    bool is_leapYear;
    int t_d_;
    double sigma_, gama_standard_meridian_, th_, delta_, B_, EoT_, lamda_, beta_, alpha_;
