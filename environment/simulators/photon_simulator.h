...
class PhotonSimulator : public Simulator {
 ...
 private:
  ...
  Vector3 get_ray_dir(const int x, const int y, const int scene_length, const int scene_width,
    const Vector3& camera_pos, const Vector3& camera_ctr, const Vector3& camera_up);
  Vector3 get_ray_color(const int x, const int y, const int scene_length, const int scene_width,
	const Vector3& camera_pos, const Vector3& camera_ctr, const Vector3& camera_up);
