...
class PhotonSimulator : public Simulator {
 public:
  PhotonSimulator(const int number, const _462::real_t distance, const _462::real_t height);
  void SimulateToTime(
 ...
 private:
  ...
  void PhotonEmit(const _462::Vector3 &sun_direction, const _462::Vector3 &sun_strength,
  ...
  void PhotonsModify();
  int RussianRoulette(const _462::real_t abr, const _462::real_t ref, const _462::real_t tran);
  ...
  _462::Vector3 GetIntersect(const _462::Vector3 &p1, const _462::Vector3 &p2, const _462::Vector3 &p3,
                        const _462::Vector3 &line_point, const _462::Vector3 &line_dir);
  bool IsInTriangle(const _462::Vector3 &a, const _462::Vector3 &b, const _462::Vector3 &c,
                   const _462::Vector3 &p);
  _462::Vector3 GetNormal(const _462::Vector3 &p1, const _462::Vector3 &p2, const _462::Vector3 &p3);
  _462::Vector3 GetPixelColor(const _462::Vector3 &ray_pos, const _462::Vector3 &ray_dir);
  _462::Vector3 GetRayDir(const int x, const int y, const int scene_length,
                      const int scene_width, const _462::Vector3 &camera_pos,
                      const _462::Vector3 &camera_ctr, const _462::Vector3 &camera_up);
  ...
  _462::Vector3 GetRefract(const _462::Vector3 &dir, const _462::Vector3 &norm, _462::real_t coef);
