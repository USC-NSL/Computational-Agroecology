...
_462::Vector2 getTexcoord(Face face, _462::Vector3 pos,
  ...
  vertex12 = vertices[face.vertex2.vi] - vertices[face.vertex1.vi];
  vertex13 = vertices[face.vertex3.vi] - vertices[face.vertex1.vi];
  vertex1p = pos - vertices[face.vertex1.vi];
  ...
  k13 = _462::length(_462::cross(vertex12, vertex1p)) /
        _462::length(_462::cross(vertex12, vertex13));
  texcoord = (k12 + k13) * texcoords[face.vertex1.vti] +
             (1 - k12) * texcoords[face.vertex2.vti] +
             (1 - k13) * texcoords[face.vertex3.vti];
  // flip x y coord
