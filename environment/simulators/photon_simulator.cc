...
Vector3 PhotonSimulator::get_Intersect(const Vector3& p1, const Vector3& p2, const Vector3& p3, const Vector3& line_point, const Vector3& line_dir)
{
...
bool PhotonSimulator::in_Triangle(const Vector3& a, const Vector3& b, const Vector3& c, const Vector3& p)
{
  Vector3 v0 = c - a;
  Vector3 v1 = b - a;
  Vector3 v2 = p - a;
...
Vector3 PhotonSimulator::get_Normal(const Vector3& p1, const Vector3& p2, const Vector3& p3) {
...
Vector3 PhotonSimulator::get_pixel_color(const Vector3& ray_pos, const Vector3& ray_dir)
{
...
Vector3 PhotonSimulator::get_ray_color(const int x, const int y, const int scene_length, const int scene_width, const Vector3& camera_pos, const Vector3& camera_ctr, const Vector3& camera_up)
{
...
Vector3 PhotonSimulator::get_ray_dir(const int x, const int y, const int scene_length, const int scene_width, const Vector3& camera_pos, const Vector3& camera_ctr, const Vector3& camera_up)
{
...
Vector3 PhotonSimulator::get_refract(const Vector3 & dir, const Vector3 & norm, real_t coef) {
