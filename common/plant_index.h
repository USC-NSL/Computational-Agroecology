...
class PlantIndex {
 public:
  ...
  //enum class ThresholdType { MIN_TEMP, MAX_TEMP, MIN_RAINFALL, MAX_RAINFALL, SUNLIGHT };
 ...
 private:
  ...
  // min temp, max temp, min rainfall, max rainfall, fifth unknown but was initialized as array of 5
